    ...
    <article>
        ...
        <div class="content clearfix">
            <div class="custom-button clearfix">
                ...
                ?>
                <div class="three-cols" style="width:25%;">
                    <a href="<?php echo get_template_directory_uri(); ?>/program/at-a-glance/day-two" title="<?php the_title(); ?>" class="btn btn__border"><?php the_title(); ?></a>
                </div>
                <?php endwhile; endif; wp_reset_query(); ?>
                <?php
                ...
                ?>
                <div class="three-cols" style="width:25%;">
                    <a href="<?php echo get_template_directory_uri(); ?>/program/at-a-glance/day-three" title="<?php the_title(); ?>" class="btn btn__border active"><?php the_title(); ?></a>
                </div>
                <?php endwhile; endif; wp_reset_query(); ?>
            </div>

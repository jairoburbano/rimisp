    ...
    <article>
        ...
        <div class="content clearfix">
            <div class="custom-button clearfix">
                ...
                ?>
                <div class="three-cols" style="width:25%;">
                    <a href="<?php echo get_template_directory_uri(); ?>/program/at-a-glance/day-one" title="<?php the_title(); ?>" class="btn btn__border active"><?php the_title(); ?></a>
                </div>
                <?php endwhile; endif; wp_reset_query(); ?>
                <?php
